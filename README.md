...
This is the code repository of paper Unlocking Black-Box Prompt Tuning Efficiency via Zeroth-Order Optimization (https://aclanthology.org/2024.findings-emnlp.871.pdf).
